...
if("FALSE" STREQUAL "TRUE")
  set(drive_SOURCE_PREFIX /home/student/watergun_2016/src/drive)
  set(drive_DEVEL_PREFIX /home/student/watergun_2016/devel)
  set(drive_INSTALL_PREFIX "")
  set(drive_PREFIX ${drive_DEVEL_PREFIX})
else()
  set(drive_SOURCE_PREFIX "")
  set(drive_DEVEL_PREFIX "")
  set(drive_INSTALL_PREFIX /home/student/watergun_2016/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'drive' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/watergun_2016/install/${idir}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${drive_dep}_FOUND)
      find_package(${drive_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${drive_dep} REQUIRED ${depend_list})
  endif()
