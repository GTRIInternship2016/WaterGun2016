...
if("FALSE" STREQUAL "TRUE")
  set(peddetector_SOURCE_PREFIX /home/student/watergun_2016/src/pedtracker)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'peddetector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/watergun_2016/install/${idir}'.  Ask the maintainer 'farious <farious@todo.todo>' to fix it.")
    endif()
