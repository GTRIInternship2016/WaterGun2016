...
"""autogenerated by genpy from camera/BoundImage.msg. Do not edit."""
import sys
...
class BoundImage(genpy.Message):
  _md5sum = "d07f7dcb39a73c0123b8e6fc14abd73b"
  _type = "camera/BoundImage"
...
"""
  __slots__ = ['img','box']
  _slot_types = ['sensor_msgs/Image','camera/BoundBox']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BoundImage, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.img is None:
        self.img = sensor_msgs.msg.Image()
      if self.box is None:
        self.box = camera.msg.BoundBox()
    else:
      self.img = sensor_msgs.msg.Image()
      self.box = camera.msg.BoundBox()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4q.pack(_x.box.x, _x.box.y, _x.box.w, _x.box.h))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.box.x, _x.box.y, _x.box.w, _x.box.h,) = _struct_4q.unpack(str[start:end])
      return self
