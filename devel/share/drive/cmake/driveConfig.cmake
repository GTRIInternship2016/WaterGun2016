...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/watergun_2016/src/drive/${idir}'.  Ask the maintainer 'student <student@todo.todo>' to fix it.")
    endif()
