...
if(NOT "/home/student/watergun_2016/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/watergun_2016/src/rosserial/rosserial_mbed/${idir}'.  Ask the maintainer 'Gary Servin <garyservin@gmail.com>' to fix it.")
    endif()
